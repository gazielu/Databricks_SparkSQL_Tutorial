...
-- MAGIC %fs ls dbfs:/user/hive/warehouse/student_delta
...
DROP TABLE IF EXISTS Student_delta;
-- Create table Student with partition
CREATE TABLE IF NOT EXISTS Student_delta (name STRING, rollno INT) PARTITIONED BY (age INT);
INSERT INTO Student VALUES('Ravi',1,35);
INSERT INTO Student VALUES('Raj',2,35);
INSERT INTO Student VALUES('Prasad',3,36);
INSERT INTO Student VALUES('Reshwanth',4,34);
...
show create table Student_delta

CREATE TABLE spark_catalog.default.student_delta (   name STRING,   rollno INT,   age INT) USING delta PARTITIONED BY (age) TBLPROPERTIES (   'Type' = 'MANAGED',   'delta.minReaderVersion' = '1',   'delta.minWriterVersion' = '2')
...
RESTORE Table Student_delta TO VERSION AS OF 5
